...
const SKILLS_DATA = [
  {
    category: "Languages",
    icon: <Code size={14} className="inline mr-1" />,
    items: ["Python", "JavaScript", "HTML", "CSS"]
  },
  {
    category: "Frameworks",
    icon: <Box size={14} className="inline mr-1" />,
    items: ["React", "Tailwind CSS", "Express", "Node.js"]
  },
  {
    category: "AI & Data",
    icon: <Cpu size={14} className="inline mr-1" />,
    items: ["LangChain", "Ollama", "Pandas", "NumPy", "Streamlit"]
  },
  {
    category: "Tools & Databases",
    icon: <Settings size={14} className="inline mr-1" />,
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2 group/list">
        {SKILLS_DATA.map((cat, ci) => (
          ...
          >
            {/* Left Column - Category Title (Increased to text-xs) */}
            <div className="md:col-span-3 text-xs font-mono text-gray-500 dark:text-slate-500 tracking-wider font-bold pt-2 select-none flex items-center gap-1">
              {cat.icon}
